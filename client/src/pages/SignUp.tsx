...
export default function SignUp() {
    ...
    const { authError, currentUserId, authLoading, setAuthError, signUp } = AuthServices();
    ...
    useEffect(() => {
        if (currentUserId && !authLoading) navigate('/basic-calculator', { replace: true });
    ...
    async function signUpButton(event: React.SyntheticEvent<HTMLFormElement, SubmitEvent>) {
    ...
    return (
        <section className='bg-[url(https://wallpaperaccess.com/full/1812965.jpg)] flex justify-center items-center p-4 h-screen relative z-10'>
            <form onSubmit={signUpButton} className="backdrop-blur-sm backdrop-brightness-50 border border-white p-4 w-120 rounded-md flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                    <label htmlFor="your-email" className="text-white text-md font-md">Email</label>
                    <input 
                        type="email" 
                        value={email}
                        placeholder="email"
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                        ...
                        <button
                            ...
                            className="absolute inset-y-0 right-0 flex cursor-pointer items-center px-3 text-gray-300 hover:text-white"
                ...
                <p className="text-center text-gray-200">Already have account? <Link className="text-blue-300" to={'/sign-in'}>Sign In</Link></p>
                <button 
                    type="submit" 
